...
public class ReadDataFromExcelSheet extends TestBase {
	...
	public ReadDataFromExcelSheet() throws IOException {
		super();
	...
	/*public static void main(String[] args) 
	{
		...
		Object[][] data = excel.getExcelDataBasedOnStartingPoint(excellocation, sheetName, "tamplologin");
		System.out.println(data);
	}*/
	
	@BeforeMethod
	public void logintstcase() throws IOException
	{
	...
	@Test(dataProvider="getExcelDataBasedOnStartingPoint")
	public void testcaserun(String username,String passwrod) throws IOException
	{
